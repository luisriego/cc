 ...
 */
class Version20180131123541 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE fos_user ADD empresa INT DEFAULT NULL');
        $this->addSql('ALTER TABLE fos_user ADD CONSTRAINT FK_957A6479B8D75A50 FOREIGN KEY (empresa) REFERENCES cliente (id)');
        $this->addSql('CREATE INDEX IDX_957A6479B8D75A50 ON fos_user (empresa)');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP INDEX IDX_957A6479B8D75A50 ON fos_user');
        $this->addSql('ALTER TABLE fos_user DROP empresa');
    }
}
