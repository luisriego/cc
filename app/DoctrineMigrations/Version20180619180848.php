 ...
 */
final class Version20180619180848 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE cliente (id INT AUTO_INCREMENT NOT NULL, profile_id INT DEFAULT NULL, endereco_id INT DEFAULT NULL, nome VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, created_at DATETIME DEFAULT NULL, email VARCHAR(255) NOT NULL, emailoculto VARCHAR(255) DEFAULT NULL, telefone VARCHAR(19) DEFAULT NULL, celular VARCHAR(19) DEFAULT NULL, contato VARCHAR(100) DEFAULT NULL, endereco VARCHAR(150) DEFAULT NULL, raiox LONGTEXT DEFAULT NULL, invisible VARCHAR(255) DEFAULT NULL, sms TINYINT(1) DEFAULT NULL, ip VARCHAR(50) DEFAULT NULL, proveedores VARCHAR(255) DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_F41C9B2554BD530C (nome), UNIQUE INDEX UNIQ_F41C9B25989D9B62 (slug), UNIQUE INDEX UNIQ_F41C9B25E7927C74 (email), UNIQUE INDEX UNIQ_F41C9B25CCFA12B8 (profile_id), UNIQUE INDEX UNIQ_F41C9B251BB76823 (endereco_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE log (id INT AUTO_INCREMENT NOT NULL, usuario_id INT DEFAULT NULL, chamado_id INT DEFAULT NULL, anterior_id INT DEFAULT NULL, atual_id INT DEFAULT NULL, data DATETIME NOT NULL, que VARCHAR(255) DEFAULT NULL, como LONGTEXT DEFAULT NULL, tipo VARCHAR(100) DEFAULT NULL, INDEX IDX_8F3F68C5DB38439E (usuario_id), INDEX IDX_8F3F68C59D9E8FBC (chamado_id), INDEX IDX_8F3F68C517EFFBE8 (anterior_id), INDEX IDX_8F3F68C576091D62 (atual_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE fos_user DROP FOREIGN KEY FK_957A64791BB76823');
