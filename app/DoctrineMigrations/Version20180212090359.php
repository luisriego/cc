 ...
 */
class Version20180212090359 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE endereco (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, logradouro VARCHAR(255) DEFAULT NULL, numero VARCHAR(20) DEFAULT NULL, complemento VARCHAR(50) DEFAULT NULL, bairro VARCHAR(100) DEFAULT NULL, cidade VARCHAR(100) DEFAULT NULL, UNIQUE INDEX UNIQ_F8E0D60EA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE profile (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, nome VARCHAR(100) DEFAULT NULL, sobrenome VARCHAR(100) DEFAULT NULL, telefone VARCHAR(25) DEFAULT NULL, celular VARCHAR(25) DEFAULT NULL, menssagem LONGTEXT DEFAULT NULL, titulo VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_8157AA0FA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE fos_user (id INT AUTO_INCREMENT NOT NULL, empresa INT DEFAULT NULL, username VARCHAR(180) NOT NULL, username_canonical VARCHAR(180) NOT NULL, email VARCHAR(180) NOT NULL, email_canonical VARCHAR(180) NOT NULL, enabled TINYINT(1) NOT NULL, salt VARCHAR(255) DEFAULT NULL, password VARCHAR(255) NOT NULL, last_login DATETIME DEFAULT NULL, confirmation_token VARCHAR(180) DEFAULT NULL, password_requested_at DATETIME DEFAULT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', nome VARCHAR(55) DEFAULT NULL, sobrenome VARCHAR(255) DEFAULT NULL, avatar VARCHAR(100) DEFAULT NULL, UNIQUE INDEX UNIQ_957A647992FC23A8 (username_canonical), UNIQUE INDEX UNIQ_957A6479A0D96FBF (email_canonical), UNIQUE INDEX UNIQ_957A6479C05FB297 (confirmation_token), UNIQUE INDEX UNIQ_957A647954BD530C (nome), UNIQUE INDEX UNIQ_957A64795804DC82 (sobrenome), INDEX IDX_957A6479B8D75A50 (empresa), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE endereco ADD CONSTRAINT FK_F8E0D60EA76ED395 FOREIGN KEY (user_id) REFERENCES fos_user (id)');
