 ...
 * @ORM\Entity(repositoryClass="App\Repository\TipoEstacaoRepository")
 */
class TipoEstacao
{
    /**
     ...
     * Add estacao
     *
     * @param \App\Entity\Estacao $estacao
     *
     * @return TipoEstacao
     */
    public function addEstacao(\App\Entity\Estacao $estacao)
    {
     ...
     * @param \App\Entity\Estacao $estacao
     */
    public function removeEstacao(\App\Entity\Estacao $estacao)
    {
